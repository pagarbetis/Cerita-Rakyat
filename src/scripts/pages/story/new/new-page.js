...
export default class NewPage {
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Masukkan keterangan lengkap cerita. Anda dapat menjelaskan apa ceritanya, dimana, kapan, dll."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
  ...
  storeSuccessfully(message) {
    Swal.fire({
      icon: 'success',
      title: 'Berhasil!',
      text: message || 'Cerita berhasil dibuat.',
  ...
  storeFailed(message) {
    Swal.fire({
      icon: 'error',
      title: 'Gagal!',
      text: message || 'Gagal menyimpan Story. Silakan coba lagi.',
      confirmButtonText: 'OK',
    });
  }
